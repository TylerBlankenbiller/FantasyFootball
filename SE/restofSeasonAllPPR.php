...
<tr class="pickRow">
	<td colspan = 20>
        ...
        <?php
			echo "<div class='titleCard'>Rest of Season Projections</div>";
        ?>
        <html>
	</td>
...
<tr class="pickRow">
    ...
    <tr>
        ...
        <?php
            ...
            function getStats($pos, $point)
            {
                ...
                if (($handle = fopen("DataBase/allActualStats.csv", "r")) !== FALSE) {
                    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                        $num = count($data);
                        $row++;
                        if($data[$num-1] == $pos and $data[$num-2] == 2018 and $data[1]>=17){
                            $name = $data[4];
                            $team = $data[6];
                            if($pos=='QB')
                            {
            ...
            $array = getStats($pos, $point);
            function retStats($array, $pos, $point)
            {
