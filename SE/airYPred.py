...
if 1 == 1:
    ...
    #test.csv!!!!!!!!!!!!!!!!!!!!!!!!!!!@#@!#@!#@!#@!#!!@predict
    training_df: pd.DataFrame = pd.read_csv("passLocation.csv", low_memory=False)
    ...
    def plot_history(history):
        ...
        plt.figure()
        plt.xlabel('Epoch')
        plt.ylabel('Mean Abs Error [air_yards]')
        ...
        plt.figure()
        plt.xlabel('Epoch')
        plt.ylabel('Mean Square Error [$air_yards^2$]')
    ...
    plt.xlabel('True Values [air_yards]')
    plt.ylabel('Predictions [air_yards]')
    plt.axis('equal')
    plt.axis('square')
    ...
    plt.xlabel("Prediction Error [air_yards]")
    _ = plt.ylabel("Count")
